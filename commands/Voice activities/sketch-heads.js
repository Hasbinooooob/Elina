    ...
    try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            if (!invite.code) return message.channel.send({embeds: [new MessageEmbed()
                .setDescription("I was unable to start a Sketch Heads session.")
        ...
        .setDescription(`Click the button below to start a Sketch Heads session in ${channel}`)
        .setColor("F037A5")
        .setFooter({
        ...
        .setTimestamp()
        .setImage("https://cdn.discordapp.com/attachments/944800400412901377/958024123534180432/Sketch-Heads.gif?size=4096")
