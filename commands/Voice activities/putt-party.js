    ...
    try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            if (!invite.code) return message.channel.send({embeds: [new MessageEmbed()
                .setDescription("I was unable to start a Putt Party session.")
        ...
        .setDescription(`Click the button below to start a Putt Party session in ${channel}`)
        .setColor("F037A5")
        .setFooter({
        ...
        console.log(e.stack)
        message.channel.send({embeds: [new MessageEmbed().setColor("DARK_RED").setDescription(`\`${e.message}\``)]})
    }
  }
}