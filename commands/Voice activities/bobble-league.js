    ...
    try {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            if (!invite.code) return message.channel.send({embeds: [new MessageEmbed()
                .setDescription("I was unable to start a Bobble League session.")
        ...
        .setDescription(`Click the button below to start a Bobble League session in ${channel}`)
        .setColor("F037A5")
        .setFooter({
        ...
        .setTimestamp()
        .setImage("https://cdn.discordapp.com/attachments/959030954234621952/985770466184691784/Bobble_League.gif?size=4096")
