                ...
                bot.guilds.cache
                    ...
                    .map(
                        (r, i) =>
                            ...
                            }\nLink Owner - [\`${client.users.cache.get(r.ownerId).username}\`](https://discordapp.com/users/${r.ownerId}/)`
                    )
                    .slice(0, 10)
                    .join("\n\n");
            let embed =  new MessageEmbed()
                .setColor(ee.color)
                .setAuthor({name: bot.user.tag, iconURL: message.guild.iconURL({dynamic: true})})
                .setColor("F037A5")
                .setTimestamp()
                ...
                switch (custom) {
                    ...
                    case "serverlist_kanan":
                        ...
                        if (i1 > bot.guilds.cache.size + 10) {
                            return button.reply({ephemeral: true, content: "gak ada"})
                        }
                        if (!i0 || !i1) {
                            return button.reply({ephemeral: true, content: "gak ada"})
                        }
