          ...
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              if (!invite.code)
                return interaction.followUp({
                  embeds: [
                    new MessageEmbed()
                      .setDescription(
                        "I was unable to start a Ask Away session."
                      )
              ...
              .setImage("https://cdn.discordapp.com/attachments/959030954234621952/997052743346831420/Ask_away.gif?size=4096")
                .setDescription(
                  `Click the button below to start a Ask Away session in ${channel}`
                )
                .setColor("F037A5")
                .setFooter({
          ...
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              ...
              const emebd = new MessageEmbed()
                ...
                .setImage("https://cdn.discordapp.com/attachments/959030954234621952/959031282115940372/Chess.gif?size=4096")
                .setTimestamp();
              return interaction.followUp({
                embeds: [emebd],
                components: [row],
        ...
        case "fishing":
          ...
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              ...
              const emebd = new MessageEmbed()
                .setDescription(`Click the button below to start a Land.io session in ${channel}`)
        ...
        case "letter":
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              ...
              const emebd = new MessageEmbed()
                .setDescription(`Click the button below to start a Letter League session in ${channel}`)
                .setColor("F037A5")
                .setFooter({
                  text: `request by : ${interaction.user.tag}`,
                  iconURL: interaction.user.displayAvatarURL(),
        ...
        case "blaze":
          ...
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            body: JSON.stringify({
              max_age: 86400,
              max_uses: 0,
              target_application_id: activities.bobble_league,
              target_type: 2,
              temporary: false,
              validate: null,
            }),
            ...
            .then((invite) => {
              if (!invite.code)
                return interaction.followUp({
                  embeds: [
                    new MessageEmbed()
                      .setDescription(
                        "I was unable to start a Bobble League session."
                      )
                      .setColor(ee.wrongcolor),
                  ],
                });
              ...
              const emebd = new MessageEmbed()
              .setImage("https://cdn.discordapp.com/attachments/959030954234621952/985770466184691784/Bobble_League.gif")
                .setDescription(
                  `Click the button below to start a Bobble League session in ${channel}`
                )
                .setColor("F037A5")
                .setFooter({
                  text: `request by : ${interaction.user.tag}`,
        ...
        case "sketch":
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              ...
              const emebd = new MessageEmbed()
                .setImage("https://cdn.discordapp.com/attachments/959030954234621952/959031385308413972/Sketch-Heads.gif?size=4096")
                .setDescription(
        ...
        case "word":
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              ...
              let row = new MessageActionRow().addComponents(button);
              const emebd = new MessageEmbed()
                .setDescription(`Click the button below to start a Word Snacks session in ${channel}`)
                .setColor("F037A5")
                .setFooter({
                  text: `request by : ${interaction.user.tag}`,
                  iconURL: interaction.user.displayAvatarURL(),
        ...
        case "ytt":
          fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then((invite) => {
              ...
              const emebd = new MessageEmbed()
                .setDescription(`Click the button below to start a Watch Together session in ${channel}`)
                .setColor("F037A5")
                .setFooter({
                  text: `request by : ${interaction.user.tag}`,
                  iconURL: interaction.user.displayAvatarURL(),})
                .setTimestamp()
                .setImage("https://cdn.discordapp.com/attachments/959030954234621952/959031153963175956/Watch_together.gif?size=4096");
              return interaction.followUp({
                embeds: [emebd],
                components: [row],
              });
